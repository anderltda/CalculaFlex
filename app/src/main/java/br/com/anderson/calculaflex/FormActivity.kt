...
import br.com.anderson.calculaflex.extensions.getDouble
import br.com.anderson.calculaflex.watchers.DecimalTextWatcher
...
class FormActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btCalculate.setOnClickListener {
            ...
            var proximaTela = Intent(this, ResultActivity::class.java)
